      ...
      {education.map((item, index) => (
        ...
        >
          ...
          {index !== education.length - 1 && (
            <div className="hidden sm:block absolute top-24 left-16 w-0.5 h-24 bg-gradient-to-b from-blue-600 to-transparent" />
          )}
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
              <div className='flex flex-row items-center justify-start'>
                ...
                <div className="block sm:hidden relative">
                  <motion.div
                    whileHover={{ scale: 1.1 }}
                    className="w-14 h-14 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl"
                  >
                    <img
                      src={item.logo}
                      alt={item.school}
